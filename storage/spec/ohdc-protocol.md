...
- Path prefix: `/ohdc.v0.OhdcService/<Method>`, `/ohdc.v0.AuthService/<Method>`, `/ohdc.v0.RelayService/<Method>`.
...
The `.proto` package name carries the major version: `ohdc.v0`. Within v0:
